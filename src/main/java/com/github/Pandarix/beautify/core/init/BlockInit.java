...
public final class BlockInit {
	 ...
	 * IN DEV
	 * 
	 * // trellis public static final RegistryObject<OakTrellis> OAK_TRELLIS =
	 * BLOCKS.register("oak_trellis", () -> new
	 * OakTrellis(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD)
