...
public final class BlockInit {
	 ...
	 * disabled in 1.18.2
	 * 
	 * public static final RegistryObject<MangroveTrellis> MANGROVE_TRELLIS =
	 * BLOCKS.register("mangrove_trellis", () -> new
	 * MangroveTrellis(BlockBehaviour.Properties.of(Material.WOOD,
	 * MaterialColor.WOOD) .strength(0.3F,
	 * 0.3F).sound(SoundType.BAMBOO).noOcclusion()));
	 */
